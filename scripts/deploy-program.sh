#!/usr/bin/env bash
#
# deploy-program.sh -- Build and deploy the KODAMA on-chain program
#
# Usage:
...
echo "=========================================="
echo "  KODAMA Program Deployment"
echo "=========================================="
...
PROGRAM_SO="$PROGRAM_DIR/target/deploy/kodama.so"
...
PROGRAM_KEYPAIR="$PROGRAM_DIR/target/deploy/kodama-keypair.json"
