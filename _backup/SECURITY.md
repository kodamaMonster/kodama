...
If you discover a security vulnerability in KODAMA, please report it responsibly:

1. Send an email to **security@kodama.com**
...
The KODAMA on-chain program handles game state and in some contexts value transfer. We take the following measures:
