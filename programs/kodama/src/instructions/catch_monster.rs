...
pub fn handler(
    ...
    require!(agent.has_team_space(), KodamaError::TeamFull);

    let species = get_species(species_id).ok_or(KodamaError::InvalidSpeciesId)?;
    ...
    require!(caught, KodamaError::CatchFailed);
